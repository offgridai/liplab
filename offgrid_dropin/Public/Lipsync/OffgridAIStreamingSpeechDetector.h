...
public:
    void Reset();
    // Retained as a source-compatible no-op for existing hosts. Speech-region
    // timing is audio-owned; transcript punctuation must not tune occupancy.
    void SetListGapSensitivity(bool) {}
