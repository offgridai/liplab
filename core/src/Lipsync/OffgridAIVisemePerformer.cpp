...
namespace
{
    ...
    static float EnvelopeAt(const FOffgridAIAlignedVisemeTrack& Track, int32 EventArrayIndex, float PlaybackSeconds)
    {
        ...
        // Treat large center gaps as local speech-region boundaries. This
        // keeps pose shoulders from bleeding across audio-occupancy pauses.
        ...
        // At resumed-speech boundaries, do not let the next pose pre-attack
        // far backward across silence.
