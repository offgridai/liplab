...
namespace
{
    ...
    // ---------------------------------------------------------------------
    // Text viseme planning.
    //
    // Contract:
    //   Text decides what visemes exist and drafts one monotonic timeline.
    //   The runtime may change when that timeline advances, but not which
    //   source events exist or their order.
